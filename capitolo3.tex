...
\subsection{Albero}
Innanzitutto definiamo cos'\`e una struttura ad albero ordinato:\\
Un \textbf{albero ordinato} \`e un grafo connesso, aciclico ed ordinato. Esso \`e una struttura dati che si compone di due sottostrutture fondamentali: 
\begin{itemize}
