...
\end{table}
\noindent
Come si pu\`o notare le sequenza di lunghezza 2 hanno tendenzialmente un \textit{PI} maggiore rispetto alle sequenze di lunghezza maggiore. Questo fatto \`e triviale in quanto le istanze coinvolte all'aumentare del numero di elementi della sequenza diminuisce e pertanto il \textit{PI} segue questa tendenza. Lo si comprende anche pensando alla struttura ad albero, man mano che si inseriscono nodi in profondit\`a, la significativit\`a della sequenza diminuisce, quindi il \textit{PI}.\\
\\
...
\\
Di seguito alcuni esempi di sequenze e la discussione dei rispettivi indici.
...
Bisogna notare per\`o un fatto tra questi due esempi, i primi due elementi della sequenza sono gli stessi: Larceny From Motor Vehicle e Larceny. Significa che essi sono altamente correlati ed influenzano molti tipi di eventi successivi.
...
L'associazione analizzata non ci comunica, attraverso i suoi indici, un grado di affidabilit\`a consistente, \`e un fatto comune per le sequenze di lunghezza 4 nelle quali gli indicatori tendono ad assumere valori medi o comunque non decisamente elevati.\\
\clearpage
\noindent
...
\begin{table}[h]
	...
	\begin{tabular}{m{8cm}|c|c|c}
		...
		\hline
		$[$'Larceny From Motor Vehicle', 'Larceny', 'Aggravated Assault'$]$ & 0.7157 & 0,0991 & 0.7543 \\
		$[$'Larceny From Motor Vehicle', 'Larceny', 'Auto Theft'$]$ & 0.7157 & 0,0575 & 0.7627\\
		$[$'Larceny From Motor Vehicle', 'Larceny', 'Residential Burglary'$]$ & 0.6907 & 0,0508 & 0.6853\\
		$[$'Larceny', 'Larceny From Motor Vehicle', 'Auto Theft'$]$ & 0.6853 & 0,0521 & 0.6907 \\ 
		$[$'Aggravated Assault', 'Larceny', 'Larceny From Motor Vehicle'$]$ & 0.6428 & 0,1262 & 0.7425 \\
		$[$'Aggravated Assault', 'Larceny', 'Residential Burglary'$]$ & 0.6428 & 0,0521 & 0.7026 \\
		$[$'Aggravated Assault', 'Larceny', 'Larceny From Motor Vehicle', 'Auto Theft'$]$ & 0.6356 & 0,0479 & 0.6356 \\		
	\end{tabular}
\end{table}
