...
\pagestyle{fancy}
\fancyhf{}
\rhead{\textit{5. Analisi dei risultati}}
\cfoot{\thepage}
...
\begin{figure}[h]
	\hspace{-1.7cm}
	\includegraphics[height=0.7 \linewidth]{pics/tempi12.png}
...
\begin{figure}[h]
	\hspace{-1.3cm}
	\includegraphics[height=0.8 \linewidth]{pics/rag_nrec.png}
...
\begin{figure}[h]
	\hspace{-1.5cm}
	\includegraphics[height=0.85 \linewidth]{pics/tem_nrec.png}
...
\begin{figure}[h]
	\hspace{-1cm}
	\includegraphics[height=0.9 \linewidth]{pics/rag_temp.png}
	\caption{tempi di computazione in funzione all'intervallo temporale e al numero record}
\end{figure}
\noindent
...
\section{Indici}
La seconda parte dell'analisi riguarda i risultati ottenuti. Per poter valutare correttamente l'importanza degli stessi vengono utilizzati degli indici\cite{silde:regole}.\\
...
\begin{figure}[h]
	\hspace{-1.25cm}
	\includegraphics[height=0.68 \linewidth]{pics/freqRel.png}
...
\begin{table}[h]
	...
	\begin{tabular}{m{8cm}|c|c|c|c}
		...
		$[$'Aggravated Assault', 'Larceny', 'Larceny From Motor Vehicle', 'Auto Theft'$]$ & 0.6356 & 0,0479 & 0.6356 & 8,4297
		 \\		
	\end{tabular}
	\caption{risultati pi\`u significativi}
\end{table}
