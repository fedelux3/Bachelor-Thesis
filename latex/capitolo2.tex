...
\pagestyle{fancy}
\fancyhf{}
\rhead{\textit{2. Stato dell'arte}}
\cfoot{\thepage}

\section{Paper}
Come precedentemente anticipato, l'algoritmo oggetto di questo lavoro \`e descritto in: 
\begin{quotation}
	\textbf{A Novel Breadth-first Strategy Algorithm for\\ Discovering Sequential Patterns from Spatio-temporal Data} (Piotr S. Maciag e Robert Bembenik, 2019)\cite{{icpram19}}
\end{quotation} 
...
\begin{figure}[h!]
	\centering
	\includegraphics[height=0.6 \linewidth]{pics/neighborhood.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[height=0.2 \linewidth]{pics/neia1.png}\hfil
	\includegraphics[height=0.2 \linewidth]{pics/neia2.png}
